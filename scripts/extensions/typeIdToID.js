export const typeIdToID = new Map([
    ...
    ['minecraft:iron_spear', 257],
    ['minecraft:stone_spear', 258],
    ['minecraft:netherite_spear', 259],
    ['minecraft:golden_spear', 260],
    ['minecraft:copper_spear', 261],
    ['minecraft:diamond_spear', 262],
    ['minecraft:wooden_spear', 263],
    ['minecraft:pink_bundle', 264],
    ['minecraft:gray_bundle', 265],
    ['minecraft:purple_bundle', 266],
    ['minecraft:cyan_bundle', 267],
    ['minecraft:bundle', 268],
    ['minecraft:light_blue_bundle', 269],
    ['minecraft:lime_bundle', 270],
    ['minecraft:orange_bundle', 271],
    ['minecraft:white_bundle', 272],
    ['minecraft:black_bundle', 273],
    ['minecraft:yellow_bundle', 274],
    ['minecraft:magenta_bundle', 275],
    ['minecraft:red_bundle', 276],
    ['minecraft:light_gray_bundle', 277],
    ['minecraft:green_bundle', 278],
    ['minecraft:blue_bundle', 279],
    ['minecraft:brown_bundle', 280],
    ['minecraft:breeze_rod', 281],
    ['minecraft:wind_charge', 282],
    ...
    ['minecraft:music_disc_bounce', 834],
    ['minecraft:chemistry_table', 835],
    ['minecraft:hard_stained_glass', 836],
    ['minecraft:hard_stained_glass_pane', 837],
    ['minecraft:colored_torch_rg', 838],
    ['minecraft:colored_torch_bp', 839],
    ['minecraft:light_block', 840],
    ['minecraft:boat', 841],
    ['minecraft:dye', 842],
    ['minecraft:banner_pattern', 843],
    ['minecraft:spawn_egg', 844],
    ['minecraft:end_crystal', 845],
    ['minecraft:glow_berries', 846],
]);